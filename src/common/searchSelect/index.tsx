...
class SearchSelect extends Component<IProps, IState, any> {
    ...
    * */
    renderMenu = () => {
        ...
        return <ul className={[styles.menuList, menuStatus ? styles.menuShow : ''].join(' ')}>
            {data.map((item: any) => {
    ...
    * */
    ...
    render() {
        const { itemName, itemRules, inputProps } = this.props;
        ...
        return (
            <div className={styles.selectWrapper} >
                <div
                    ...
                    <span className={inputValue ? `${styles.searchIcon} ${styles.searchHide}` : styles.searchIcon}>
