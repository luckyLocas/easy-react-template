...
class ConcretTable<T> extends Component<MyTableProps<T>, IState, any> {
     ...
     * @param data 请求参数
     * */
    async queryTable(data: queryParams) {
     ...
     * */
    updateDataOne(data: any, key: string = 'id') {
    ...
    render() {
        const { queryDom, queryBtnDoms, hideQueryBtn, tree, btnGroup, settingQueryStyle, settingQuery, columns, rowKey, rowClick, ...extra } = this.props
        const {
            showTree,
            treeShowOrHide,
            showSetting,
